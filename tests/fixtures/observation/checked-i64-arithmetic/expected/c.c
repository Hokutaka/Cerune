...
int main(void) {
    int64_t cerune_binding_0_value = 8;
    printf("%lld\n", (long long)(cerune_i64_add(cerune_binding_0_value, 1, " node=3 bytes=22..31\n")));
    printf("%lld\n", (long long)(cerune_i64_sub(cerune_binding_0_value, 1, " node=7 bytes=40..49\n")));
    printf("%lld\n", (long long)(cerune_i64_mul(cerune_binding_0_value, 2, " node=11 bytes=58..67\n")));
    printf("%lld\n", (long long)(cerune_i64_div(cerune_binding_0_value, 2, " node=15 bytes=76..85\n")));
    printf("%lld\n", (long long)(cerune_i64_neg(cerune_binding_0_value, " node=19 bytes=94..100\n")));
    return 0;
}
