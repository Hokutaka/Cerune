(module
  ...
  (func $cerune_i64_add_n1_b9_14 (param $left i64) (param $right i64) (result i64)
    (local $result i64)
    local.get $left
    local.get $right
    i64.add
    ...
    i64.lt_s
    if
      ;; cerune: runtime-v1 code=integer-overflow node=1 bytes=9..14
      i32.const 99
