...
@cerune.failure.1.9.14.0 = private unnamed_addr constant [60 x i8] c"\63\65\72\75\6E\65\3A\20\72\75\6E\74\69\6D\65\2D\76\31\20\63\6F\64\65\3D\69\6E\74\65\67\65\72\2D\6F\76\65\72\66\6C\6F\77\20\6E\6F\64\65\3D\31\20\62\79\74\65\73\3D\39\2E\2E\31\34\0A"
@cerune.failure.1.9.14 = private constant [12 x { ptr, i64 }] [{ ptr, i64 } { ptr @cerune.failure.1.9.14.0, i64 60 }, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer]
...
entry:
  %cerune_x = alloca i64
  %tmp0 = call i64 @cerune_i64_add(i64 1, i64 2, ptr @cerune.failure.1.9.14)
  store i64 %tmp0, ptr %cerune_x
  %tmp1 = load i64, ptr %cerune_x
