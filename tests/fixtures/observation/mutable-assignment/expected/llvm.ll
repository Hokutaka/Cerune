...
@cerune.failure.3.29.38.0 = private unnamed_addr constant [61 x i8] c"\63\65\72\75\6E\65\3A\20\72\75\6E\74\69\6D\65\2D\76\31\20\63\6F\64\65\3D\69\6E\74\65\67\65\72\2D\6F\76\65\72\66\6C\6F\77\20\6E\6F\64\65\3D\33\20\62\79\74\65\73\3D\32\39\2E\2E\33\38\0A"
@cerune.failure.3.29.38 = private constant [12 x { ptr, i64 }] [{ ptr, i64 } { ptr @cerune.failure.3.29.38.0, i64 61 }, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer]
...
entry:
  ...
  %cerune_ratio = alloca float
  store i64 40, ptr %cerune_count
  %tmp0 = load i64, ptr %cerune_count
  %tmp1 = call i64 @cerune_i64_add(i64 %tmp0, i64 2, ptr @cerune.failure.3.29.38)
  store i64 %tmp1, ptr %cerune_count
  store float 0x3FD0000000000000, ptr %cerune_ratio
  %tmp2 = load float, ptr %cerune_ratio
  %tmp3 = fmul float %tmp2, 0x4000000000000000
  store float %tmp3, ptr %cerune_ratio
  %tmp4 = load i64, ptr %cerune_count
  call i32 (ptr, ...) @printf(ptr @.fmt_i64, i64 %tmp4)
  %tmp5 = load float, ptr %cerune_ratio
