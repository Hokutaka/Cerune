...
cerune_origin_n15_main_6:
  movsd .Lcerune_f64_1(%rip), %xmm0
# cerune-origin: #14 bytes 127..131
cerune_origin_n14_main_7:
  xorpd .Lcerune_sign_f64(%rip), %xmm0
# cerune-origin: #13 bytes 121..132
cerune_origin_n13_main_8:
  movsd %xmm0, -8(%rbp)
# cerune-origin: #13 bytes 121..132
cerune_origin_n13_main_9:
  movsd -8(%rbp), %xmm0
  callq cerune_fn_value_0
# cerune-origin: #12 bytes 111..133
cerune_origin_n12_main_10:
  # policy: ceil
  movapd %xmm0, %xmm2
  ucomisd %xmm2, %xmm2
...
cerune_origin_n11_main_11:
  movq %rax, %rsi
  leaq .Lcerune_fmt_i64(%rip), %rdi
  xorl %eax, %eax
  callq printf
# cerune-origin: #19 bytes 159..162
cerune_origin_n19_main_12:
  movsd .Lcerune_f64_2(%rip), %xmm0
# cerune-origin: #18 bytes 153..163
cerune_origin_n18_main_13:
  movsd %xmm0, -8(%rbp)
# cerune-origin: #18 bytes 153..163
cerune_origin_n18_main_14:
  movsd -8(%rbp), %xmm0
  callq cerune_fn_value_0
# cerune-origin: #17 bytes 142..164
cerune_origin_n17_main_15:
  # policy: round
  movapd %xmm0, %xmm2
  ucomisd %xmm2, %xmm2
...
cerune_origin_n16_main_16:
  movq %rax, %rsi
  leaq .Lcerune_fmt_i64(%rip), %rdi
  xorl %eax, %eax
  callq printf
# cerune-origin: #23 bytes 200..203
cerune_origin_n23_main_17:
  movsd .Lcerune_f64_3(%rip), %xmm0
# cerune-origin: #22 bytes 194..204
cerune_origin_n22_main_18:
  movsd %xmm0, -8(%rbp)
# cerune-origin: #22 bytes 194..204
cerune_origin_n22_main_19:
  movsd -8(%rbp), %xmm0
  callq cerune_fn_value_0
# cerune-origin: #21 bytes 173..205
cerune_origin_n21_main_20:
...
cerune_origin_n20_main_21:
  movq %rax, %rsi
  leaq .Lcerune_fmt_i64(%rip), %rdi
  xorl %eax, %eax
  callq printf
# cerune-origin: #27 bytes 241..246
cerune_origin_n27_main_22:
  movsd .Lcerune_f64_4(%rip), %xmm0
# cerune-origin: #26 bytes 235..247
cerune_origin_n26_main_23:
  movsd %xmm0, -8(%rbp)
# cerune-origin: #26 bytes 235..247
cerune_origin_n26_main_24:
  movsd -8(%rbp), %xmm0
  callq cerune_fn_value_0
# cerune-origin: #25 bytes 214..248
cerune_origin_n25_main_25:
...
cerune_origin_n24_main_26:
  movq %rax, %rsi
  leaq .Lcerune_fmt_i64(%rip), %rdi
  xorl %eax, %eax
  callq printf
# cerune-origin: #32 bytes 285..288
cerune_origin_n32_main_27:
  movsd .Lcerune_f64_5(%rip), %xmm0
# cerune-origin: #31 bytes 284..288
cerune_origin_n31_main_28:
  xorpd .Lcerune_sign_f64(%rip), %xmm0
# cerune-origin: #30 bytes 278..289
cerune_origin_n30_main_29:
  movsd %xmm0, -8(%rbp)
# cerune-origin: #30 bytes 278..289
cerune_origin_n30_main_30:
  movsd -8(%rbp), %xmm0
  callq cerune_fn_value_0
# cerune-origin: #29 bytes 257..290
cerune_origin_n29_main_31:
...
cerune_origin_n28_main_32:
  movq %rax, %rsi
  leaq .Lcerune_fmt_i64(%rip), %rdi
  xorl %eax, %eax
  callq printf
# cerune-origin: #36 bytes 325..330
cerune_origin_n36_main_33:
  movsd .Lcerune_f64_6(%rip), %xmm0
# cerune-origin: #35 bytes 319..331
cerune_origin_n35_main_34:
  movsd %xmm0, -8(%rbp)
# cerune-origin: #35 bytes 319..331
cerune_origin_n35_main_35:
  movsd -8(%rbp), %xmm0
  callq cerune_fn_value_0
# cerune-origin: #34 bytes 299..332
cerune_origin_n34_main_36:
...
cerune_origin_n33_main_37:
  movq %rax, %rsi
  leaq .Lcerune_fmt_i64(%rip), %rdi
  xorl %eax, %eax
  callq printf
# cerune-origin: #40 bytes 368..373
cerune_origin_n40_main_38:
  movsd .Lcerune_f64_7(%rip), %xmm0
# cerune-origin: #39 bytes 362..374
cerune_origin_n39_main_39:
  movsd %xmm0, -8(%rbp)
# cerune-origin: #39 bytes 362..374
cerune_origin_n39_main_40:
  movsd -8(%rbp), %xmm0
  callq cerune_fn_value_0
# cerune-origin: #38 bytes 341..375
cerune_origin_n38_main_41:
...
cerune_origin_n41_main_47:
  movq %rax, %rsi
  leaq .Lcerune_fmt_i64(%rip), %rdi
  xorl %eax, %eax
  callq printf
# cerune-origin: #47 bytes 437..442
cerune_origin_n47_main_48:
  movabsq $3, %rax
# cerune-origin: #45 bytes 431..444
cerune_origin_n45_main_49:
  movq %rax, %rsi
  leaq .Lcerune_fmt_i64(%rip), %rdi
  xorl %eax, %eax
  callq printf
