...
@cerune.failure.13.115.117.0 = private unnamed_addr constant [64 x i8] c"\63\65\72\75\6E\65\3A\20\72\75\6E\74\69\6D\65\2D\76\31\20\63\6F\64\65\3D\69\6E\74\65\67\65\72\2D\6F\76\65\72\66\6C\6F\77\20\6E\6F\64\65\3D\31\33\20\62\79\74\65\73\3D\31\31\35\2E\2E\31\31\37\0A"
@cerune.failure.13.115.117 = private constant [12 x { ptr, i64 }] [{ ptr, i64 } { ptr @cerune.failure.13.115.117.0, i64 64 }, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer, { ptr, i64 } zeroinitializer]
...
entry:
  ...
  %cerune_value_1 = alloca i1
  store i64 1, ptr %cerune_value
  %tmp0 = load i64, ptr %cerune_value
  %tmp1 = icmp slt i64 %tmp0, 2
  br i1 %tmp1, label %block0, label %block1
block0: ; if_then
  store i64 42, ptr %cerune_value
  store i1 1, ptr %cerune_value_1
  %tmp2 = load i1, ptr %cerune_value_1
  %tmp3 = select i1 %tmp2, ptr @.bool_true, ptr @.bool_false
  call i32 @puts(ptr %tmp3)
  br label %block2
block1: ; if_else
  %tmp4 = call i64 @cerune_i64_sub(i64 0, i64 1, ptr @cerune.failure.13.115.117)
  store i64 %tmp4, ptr %cerune_value
  br label %block2
block2: ; if_end
  %tmp5 = load i64, ptr %cerune_value
